...
LAYER_ENTRY(SOFTMAXCROSSENTROPYLOSS, LAYER_ID(100), softmaxcrossentropyloss,
            forward_softmaxcrossentropyloss, NULL, NULL)
LAYER_ENTRY(SOFTMAXCROSSENTROPYLOSSGRAD, LAYER_ID(101), softmaxcrossentropylossgrad,
            backward_softmaxcrossentropylossgrad, NULL, NULL)
LAYER_ENTRY(INPLACEACCUMULATORV2, LAYER_ID(102), inplaceaccumulatorv2,
            backward_inplaceaccumulatorv2, NULL, NULL)
